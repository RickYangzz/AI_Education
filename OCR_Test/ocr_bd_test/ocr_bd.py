...
def main():
    ...
    # image 可以通过 get_file_content_as_base64("C:\fakepath\demo_1.png",True) 方法获取
    payload = f"image={get_file_content_as_base64(FILE_PATH,True)}&detect_direction=false&probability=false"
    headers = {
